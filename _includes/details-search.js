    ...
    */
    ...
    map.addLayer({
      ...
      'paint': {
        ...
        'circle-color': [
          'case',
          ['get', 'selected'],
          '#764ba2',  // Selected color (purple)
          '#ee4e8b'   // Default color (pink/red)
        ],
        'circle-stroke-width': [
          'case',
          ['get', 'selected'],
    ...
    map.addLayer({
      ...
      'layout': {
        ...
        'text-offset': [0, 0.5],  // Offset below the pin
        'text-anchor': 'top',  // Anchor at top so text appears below icon
        'text-size': [
          'case',
          ['get', 'selected'],
          12,  // Larger text when selected
